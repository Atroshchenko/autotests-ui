...
with sync_playwright() as playwright:
        ...
        #вот пример более простой записи т.к. Playwright из коробки умеет работать с уникальными id
        ...
        page.wait_for_timeout(5000) #используется только для этого теста для понимания что происходит